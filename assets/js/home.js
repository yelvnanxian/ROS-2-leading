...
function renderData() {
  ...
  const nextHref = nextModule === 'environment' ? './modules/00/index.html' : nextModule === 'communication' ? './modules/01/index.html' : nextModule === 'navigation' ? './modules/02/index.html' : nextModule === 'packages' ? './modules/03/index.html' : './modules/04/index.html';
