...
(async () => {
  ...
  const existingModules = [
    {file:'module-00.html', param:'task', keys:module00Tasks, item:'data-task', stage:'[data-env-stage="learn"].active'},
    {file:'module-01.html', param:'mission', keys:module01Missions, item:'data-mission', stage:'[data-lesson-stage="concept"].active'},
    {file:'module-02.html', param:'lesson', keys:module02Lessons, item:'data-lesson', stage:'[data-stage="understand"].active'}
  ];
  ...
  for (const lesson of module03Lessons) {
    await page.goto(`${baseURL}/module-03.html?lesson=${lesson}`, {waitUntil:'networkidle'});
  ...
  for (const lesson of module04Lessons) {
    await page.goto(`${baseURL}/module-04.html?lesson=${lesson}`, {waitUntil:'networkidle'});
  ...
  await page.goto(`${baseURL}/module-04.html?lesson=odometry_message`, {waitUntil:'networkidle'});
  ...
  await page.goto(`${baseURL}/module-03.html?lesson=package_model`, {waitUntil:'networkidle'});
  ...
  await page.goto(`${baseURL}/module-00.html?task=requirements`, {waitUntil:'networkidle'});
  ...
  await page.goto(`${baseURL}/module-01.html?mission=intro`, {waitUntil:'networkidle'});
  ...
  await page.waitForURL(/module-02\.html\?lesson=field_assessment/);
  ...
  await page.waitForURL(/module-03\.html/);
  assert(await page.locator('[data-lesson="package_model"].active').count() === 1, 'Module 02 末尾没有进入 Module 03 起点');

  await page.goto(`${baseURL}/module-03.html?lesson=field_delivery`, {waitUntil:'networkidle'});
  await page.evaluate(() => {
  ...
  await page.reload({waitUntil:'networkidle'});
  await page.locator('#nextLesson').click();
  await page.waitForURL(/module-04\.html/);
  ...
  await page.locator('#previousLesson').click();
  await page.waitForURL(/module-03\.html\?lesson=field_delivery/);
  assert(await page.locator('[data-lesson="field_delivery"].active').count() === 1, 'Module 04 第一节返回未到 Module 03 末节');

  await page.goto(`${baseURL}/module-02.html?lesson=mapping_launch`, {waitUntil:'networkidle'});
  for (let index = 0; index < 3; index += 1) await page.locator(`[data-concept="${index}"]`).click();
  await page.locator('[data-stage="chain"]').click();
  ...
  await mobilePage.goto(`${baseURL}/module-03.html?lesson=creator_preflight`, {waitUntil:'networkidle'});
  ...
  await mobilePage.goto(`${baseURL}/module-04.html?lesson=path_validation`, {waitUntil:'networkidle'});
  ...
  for (const target of [
    'module-00.html?task=validation',
    'module-01.html?mission=assessment',
    'module-02.html?lesson=field_assessment'
  ]) {
